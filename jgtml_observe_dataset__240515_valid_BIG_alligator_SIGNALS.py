...
- not_in_lips_teeth
- sig_is_in_bteeth
- big_m_open_in_bteeth
- sig_in_blips_bmouth_is_open
...
sel_columns_buy = [HIGH,LOW,BJAW,BLIPS,BTEETH,JAW,TEETH,LIPS,FDBB,FDB_TARGET,VECTOR_AO_FDBB_COUNT,VECTOR_AO_FDB_COUNT]
...
if bs=="S":
    ...
    #sig_is_in_bteeth
    sig_is_in_bteeth = not_in_lips_teeth[
    not_in_lips_teeth['High'] < not_in_lips_teeth['bteeth']
    ].copy()
    ...
    #sig_in_blips_bmouth_is_open
    sig_in_blips_bmouth_is_open = not_in_lips_teeth[
        not_in_lips_teeth['High'] > not_in_lips_teeth['blips']
        ].copy()
...
big_m_open_in_bteeth_sum=big_m_open_in_bteeth[FDB_TARGET].sum()

# %%

if not quiet:
    print(big_m_open_in_bteeth.tail(40))
...
sig_in_blips_bmouth_is_open_sum=sig_in_blips_bmouth_is_open[FDB_TARGET].sum()

# %%
if not quiet:
    print(sig_in_blips_bmouth_is_open.tail(40))
