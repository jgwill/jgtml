...
def parse_args():
  parser=jgtcommon.new_parser("FDB Scanner 2508","Scan market for FDB signals (August 2025 version)","fdbscan2",add_exiting_quietly_flag=True)
