...
# Mon 24 Jun 2024 06:54:38 PM EDT
...
def main():
    ...
    if not args.use_env or not use_env:
        i = args.instrument
        t = args.timeframe
        bs = args.buysell
...
result_drop_base = create_result_directory(jgtdroot, drop_subdir, result_drop_base_override)
