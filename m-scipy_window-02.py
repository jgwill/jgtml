...
window_type = "blackman"  # You can choose from various window types such as 'hamming', 'hann', 'blackman', etc.
...
wints= pd.DataFrame(windowed_time_series)
